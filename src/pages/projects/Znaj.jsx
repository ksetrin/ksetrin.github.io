...
import screen1 from '@/assets/images/screenshots/znaj/screen-1.png';
import screen2 from '@/assets/images/screenshots/znaj/screen-2.png';
import screen3 from '@/assets/images/screenshots/znaj/screen-3.png';
import screen4 from '@/assets/images/screenshots/znaj/screen-4.png';
import screen5 from '@/assets/images/screenshots/znaj/screen-5.png';
import screen6 from '@/assets/images/screenshots/znaj/screen-6.png';
import screen7 from '@/assets/images/screenshots/znaj/screen-7.png';
import screen8 from '@/assets/images/screenshots/znaj/screen-8.png';
import screen9 from '@/assets/images/screenshots/znaj/screen-9.png';
import screen10 from '@/assets/images/screenshots/znaj/screen-10.png';
import screen11 from '@/assets/images/screenshots/znaj/screen-11.png';
import screen12 from '@/assets/images/screenshots/znaj/screen-12.png';
import screen13 from '@/assets/images/screenshots/znaj/screen-13.png';
...
const ZnajProject = () => {
    ...
    const screenshots = [screen1, screen2, screen3, screen4, screen5, screen6, screen7, screen8, screen9, screen10, screen11, screen12, screen13, screen14, screen15, screen16];
                                ...
                                {screenshots.map((screenshot, index) => (
                                    ...
                                    >
                                        <div className="relative w-56 h-[30rem] bg-white dark:bg-gray-800 rounded-2xl shadow-lg group-hover:shadow-2xl transition-all duration-300 group-hover:scale-105">
                                            <img
                                                src={screenshot}
                                                alt={`Znaj App Screenshot ${index + 1}`}
                                                className="w-full h-full object-cover rounded-2xl"
                                                onError={(e) => {
                                                    e.target.src = 'data:image/svg+xml;base64,';
                                                }}
                                            />
