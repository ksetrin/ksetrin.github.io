...
import screen1 from '@/assets/images/screenshots/tapcar/screen-1.png';
import screen2 from '@/assets/images/screenshots/tapcar/screen-2.png';
import screen3 from '@/assets/images/screenshots/tapcar/screen-3.png';
import screen4 from '@/assets/images/screenshots/tapcar/screen-4.png';
import screen5 from '@/assets/images/screenshots/tapcar/screen-5.png';
import screen6 from '@/assets/images/screenshots/tapcar/screen-6.png';
...
const TapcarProject = () => {
    ...
    const screenshots = [screen1, screen2, screen3, screen4, screen5, screen6, screen7, screen8, screen9];
                                ...
                                {screenshots.map((screenshot, index) => (
                                    ...
                                    >
                                        <div className="relative w-56 h-[30rem] bg-white dark:bg-gray-800 rounded-2xl shadow-lg group-hover:shadow-2xl transition-all duration-300 group-hover:scale-105">
                                            <img
                                                src={screenshot}
                                                alt={`TapCar App Screenshot ${index + 1}`}
                                                className="w-full h-full object-cover rounded-2xl"
                                                onError={(e) => {
                                                    e.target.src = 'data:image/svg+xml;base64,';
                                                }}
                                            />
