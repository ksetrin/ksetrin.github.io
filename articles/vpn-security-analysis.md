...
slug: "vpn-security-analysis"
lang: "ru"
datePublished: "2024-02-15"
dateModified: "2024-02-15"
author: "Пётр Евсиков"
tldr: ["VPN может выступать MITM и читать трафик", "Сертификаты и pinning защищают от незаметной подмены", "Аудит инфраструктуры и мониторинг критичны для приватности"]
---
